...
| Config | Date (UTC) | Commit | Accuracy (strict) | Accuracy (lenient) | Faithfulness | $/question | Δ vs previous | Note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| gpt-5.4 | 2026-09-22 | 27cad30 | 58.1% | - | 87.5% | $0.0202 | accuracy +16.3 pp, faithfulness -6.9 pp, $/question -$0.0034 | after baseline fixes |

### All runs

| Date (UTC) | Commit | Note | Config | Models | Dataset | Schema | Roles | Passes | Accuracy (strict) | Accuracy (lenient) | Faithfulness | $/question | Δ vs previous | Answerability P / R | Tokens/question (in / cached / out) | p50 | p95 | Determinism | Status |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-09-22 14:18:51 | 27cad30 | after baseline fixes | gpt-5.4 | openai:gpt-5.4 (answersynthesizer, astplanner, datasourceresolver, decomposer, refiner) | chinook_gold.yaml @7d104084 | @ceed80fe | admin | 1 | 58.1% | - | 87.5% | $0.0202 | accuracy +16.3 pp, faithfulness -6.9 pp, $/question -$0.0034 | 100.0% / 75.0% | 10,655 / 7,082 / 633 | 8.54s | 10.99s | - | complete |
