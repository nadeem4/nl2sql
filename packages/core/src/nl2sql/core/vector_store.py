...
from nl2sql.core.embeddings import EmbeddingService
from nl2sql_adapter_sdk import SchemaMetadata, Table, Column
from nl2sql.core.datasource_config import DatasourceProfile, load_profiles
...
class OrchestratorVectorStore:
    ...
    def index_examples(self, examples_path: str, llm=None):
        ...
        import yaml
        import pathlib
        from nl2sql.core.indexing_agents import canonicalize_query, enrich_question
