...
ENV_SPECIFIC_SETTINGS = {
    "demo": (
        ...
        "\n# --- Timeouts ---\n"
        "# A live run walks the resolver's answerability check, decomposer,\n"
        "# planner, refiner, sql_agent and synthesizer, each a real provider\n"
        "# call; an observed OpenAI run took\n"
