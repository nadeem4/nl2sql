...
COUNT_CUSTOMERS_PLAN = {
    ...
    "joins": [],
    "select_items": [{"alias": "customer_count",
...
ALBUMS_PER_ARTIST_PLAN = {
    ...
    "tables": [
        {"name": "Album", "alias": "t1"},
        {"name": "Artist", "alias": "t2"},
    ],
    "joins": [{
        "left_alias": "t1", "right_alias": "t2", "join_type": "inner",
    ...
    "group_by": [{"expr": {"kind": "column", "alias": "t2", "column_name": "Name"}}],
    "order_by": [],
...
TOP_GENRE_PLAN = {
    ...
    "joins": [
        ...
        {"left_alias": "t2", "right_alias": "t3", "join_type": "inner",
         "condition": {"kind": "binary", "op": "=",
    ...
    "group_by": [{"expr": {"kind": "column", "alias": "t3", "column_name": "Name"}}],
...
JAZZ_TRACKS_PLAN = {
    ...
    "select_items": [{"alias": "track_count",
                      "expr": {"kind": "func", "func_name": "COUNT", "is_aggregate": True,
...
TOP_CUSTOMERS_PLAN = {
    "query_type": "READ", "distinct": False,
    "tables": [
        {"name": "Customer", "alias": "t1"},
        {"name": "Invoice", "alias": "t2"},
    ],
    "joins": [{
        "left_alias": "t2", "right_alias": "t1", "join_type": "inner",
        "condition": {"kind": "binary", "op": "=",
    ...
    "group_by": [{"expr": {"kind": "column", "alias": "t1", "column_name": "CustomerId"}}],
    "order_by": [],
